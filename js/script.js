window.addEventListener("load",()=>{
  ...
  const executa = () => {
    if (document.title === 'PhotoPet - Nossa gallery') {
      modalEvents();
      getCats();
      getDogs();
      getFoxes();
    } else if (document.title === 'PhotoPet - Página Inicial') {
      imageGallery()
    }
  }
...
function pricing(event) {
  ...
  document.querySelector('#result-pricing').innerHTML = `Olá, ${nome}, o seu orçamento fica em R\$${precoFinalFormatado}. <br> Para confirmar, nos envie uma mensagem no whatsapp.<br>`
  document.querySelector('#result-pricing').innerHTML += ` <a href="https://api.whatsapp.com/send?phone=5541992693665&text=Ol%C3%A1%2C%20meu%20nome%20%C3%A9%20${nome}%2C%20quero%20confirmar%20o%20or%C3%A7amento%20de%20${qtdFotos}%20fotos%20no%20valor%20de%20${precoFinalFormatado}%20reais.%20Como%20realizo%20o%20pagamento%3F" class="btn btn-success btn-sm" type="submit" target="_blank">Enviar mensagem</a>`
}